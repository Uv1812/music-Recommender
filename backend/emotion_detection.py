...
class EmotionDetector:
    ...
    # If no emojis, use keyword matching
        keywords = {
            'happy': ['not sad','happy', 'joy', 'joyful', 'excited', 'good', 'great', 'fun', 'smile', 'laugh', 'enjoy', 'friends', 'celebrate', 'celebration', 'dance', 'party'],
            'sad': ['not happy','sad', 'unhappy', 'cry', 'tears', 'depressed', 'lonely', 'miss', 'alone', 'heartbroken', 'broken', 'upset', 'miserable', 'unfortunate', 'grief', 'sorrow'],
            'angry': ['not calm','angry', 'mad', 'hate', 'furious', 'annoyed', 'frustrated', 'irritated', 'outraged', 'rage', 'fury', 'temper', 'hostile'],
    ...
    def preprocess(self, text):
        ...
        contractions = {
            "imnt": "i am not", "dont": "do not", "cant": "cannot", "wont": "will not",
