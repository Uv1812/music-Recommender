...
try:
    ...
    config = {
        "YOUTUBE_API_KEY": os.getenv("YOUTUBE_API_KEY", "AIzaSyAyfyq69jAGCTYBXnZUicv5IFGnu8euquM"),
        "SPOTIFY_CLIENT_ID": os.getenv("SPOTIFY_CLIENT_ID", "b4cef9bb3bcd48868b1ff37499b97441"),
        "SPOTIFY_CLIENT_SECRET": os.getenv("SPOTIFY_CLIENT_SECRET", "59be44e75d164fa9a5447d34d7408eb6")
    }
